...
- `<Scrap Mechanic User>\Mods\JC_ScrapMap_RoadExporter`
...
If Windows, Steam, the game, or the computer interrupts option 2:
...
- the temporary user mod named `JC_ScrapMap_RoadExporter`;
...
captured road/water maps and means option 2 must be run again when those maps
are wanted.
