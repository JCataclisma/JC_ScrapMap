...
JC ScrapMap 0.6.0 ships as readable source code.
...
The Lua exporter reads generated road and water flags once and writes a small
JSON result into its mapper-owned mod directory. It does not call
