...
JC ScrapMap 0.12.5 is provided as readable source code.
...
- `scrapmap.py` — read-only map inspection, raw temporary player snapshot,
  exact Recycler detection and transaction, explicit Instant Recovery save
  transaction, map state, and local server
